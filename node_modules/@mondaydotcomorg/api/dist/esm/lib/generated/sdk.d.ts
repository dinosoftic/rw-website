...
export declare enum BoardEditPermissions {
    /** Assignee */
    Assignee = "assignee",
    /** Collaborators */
...
export declare enum BoardViewPermissions {
...
export declare enum CustomActivityColor {
...
export declare enum CustomActivityIcon {
    Ascending = "ASCENDING",
    Camera = "CAMERA",
...
export declare enum DiscountPeriod {
    Monthly = "MONTHLY",
    Yearly = "YEARLY"
}
/** Various documents blocks types, such as text. */
export declare enum DocBlockContentType {
    /** Bulleted list block */
...
/** Options to order by. */
export declare enum DocsOrderBy {
...
export declare enum FileLinkValueKind {
    /** Box file */
    Box = "box",
    /** Dropbox file */
    Dropbox = "dropbox",
...
export declare enum FolderCustomIcon {
    /** Folder */
    Folder = "FOLDER",
    /** MoreBelow */
    Morebelow = "MOREBELOW",
...
export declare enum FolderFontWeight {
    /** font-weight-bold */
...
export declare enum ItemsOrderByDirection {
    /** Ascending order */
    Asc = "asc",
    /** Descending order */
    Desc = "desc"
...
export declare enum ItemsQueryOperator {
    /** Logical AND */
    And = "and",
    /** Logical OR */
    Or = "or"
...
export declare enum ItemsQueryRuleOperator {
    /** Any of the values */
    AnyOf = "any_of",
...
export declare enum NumberValueUnitDirection {
...
export type GetMeOpQueryVariables = Exact<{
    [key: string]: never;
}>;
...
export declare const GetMeOpDocument: import("graphql").DocumentNode;
export declare const ChangeSimpleColumnValueOpDocument: import("graphql").DocumentNode;
export declare const ChangeColumnValueOpDocument: import("graphql").DocumentNode;
export declare const CreateItemOpDocument: import("graphql").DocumentNode;
export declare const ChangeMultipleColumnValuesOpDocument: import("graphql").DocumentNode;
export declare const GetBoardItemsOpDocument: import("graphql").DocumentNode;
export declare const GetBoardGroupsOpDocument: import("graphql").DocumentNode;
